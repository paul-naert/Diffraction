...
///
///////////////////////////////////////////////////////////////////////////////
CNuanceurProg::CNuanceurProg(const char* nuanceurSommetsStr, const char* nuanceurFragmentsStr, bool compilerMaintenant)
...
void CNuanceurProg::uniform1(const char* nom, int v)
{
    glUniform1i(glGetUniformLocation(prog_, nom), v);
}

void CNuanceurProg::uniform1(const char* nom, float v)
{
...
///
///////////////////////////////////////////////////////////////////////////////
void CNuanceurProg::afficherShaderInfoLog(GLuint obj, const char* message)
{
    int   infologLength = 0;
    int   charsWritten  = 0;
    char* infoLog;
...
///
///////////////////////////////////////////////////////////////////////////////
void CNuanceurProg::afficherProgramInfoLog(GLuint obj, const char* message)
{
    int   infologLength = 0;
    int   charsWritten  = 0;
    char* infoLog;
...
///
///////////////////////////////////////////////////////////////////////////////
void CNuanceurProg::compilerEtLierNuanceurs(const char* nsStr, const char* nfStr)
{
