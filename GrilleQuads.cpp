...
CGrilleQuads::CGrilleQuads(const char* nomFichierTexture, float largeur, float hauteur, int nbColonnes, int nbRangees,
                           float echelle, bool mipmap, bool bumpy)
...
CGrilleQuads::CGrilleQuads(const std::vector<const char*>* nomsFichiersTextures, float largeur, float hauteur,
                           int nbColonnes, int nbRangees, float echelle, bool mipmap, bool bumpy)
