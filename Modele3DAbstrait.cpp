...
///
///////////////////////////////////////////////////////////////////////////////
CModele3DAbstrait::CModele3DAbstrait(float echelle, const char* nomFichierTexture, TEXTypeEnum texType = TYPE_TEXTURE2D,
                                     bool compilerTex, bool mipmap)
    : texType_(texType)
    , echelle_(echelle)
    , mipmap_(mipmap)
    , compilerTex_(compilerTex)
{
...
///
///////////////////////////////////////////////////////////////////////////////
CModele3DAbstrait::CModele3DAbstrait(float echelle, const std::vector<const char*>* nomsFichiersTextures,
