...
public:
    ...
    CGrilleQuads(const char* nomFichierTexture, float largeur, float hauteur, int nbColonnes, int nbRangees,
    ...
    CGrilleQuads(const std::vector<const char*>* nomsFichiersTextures, float largeur, float hauteur, int nbColonnes,
