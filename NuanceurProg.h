...
public:
   ...
   CNuanceurProg(const char* nuanceurSommetsStr, const char* nuanceurFragmentsStr, bool compilerImmediatement);
   ...
   void uniform1(const char* nom, int v);

   /// Permet de lancer une valeur uniform (float) immédiatement
   void uniform1(const char* nom, float v);
...
private:
   ...
   void compilerEtLierNuanceurs(const char* nsStr, const char* nfStr);
