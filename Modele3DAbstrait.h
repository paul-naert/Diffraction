...
public:
	...
	CModele3DAbstrait(float echelle, const char* nomFichierTexture, TEXTypeEnum texType, bool compilerTex = true, bool mipmap = false);
	/// constructeur créant un modèle 3D générique comportant plusieurs textures
	CModele3DAbstrait(float echelle, const std::vector<const char*>* nomsFichiersTextures, TEXTypeEnum texType, bool compilerTex = true, bool mipmap = false);
